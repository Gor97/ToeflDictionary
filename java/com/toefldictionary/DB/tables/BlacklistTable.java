...
public class BlacklistTable {
    ...
    public static final String COLUMN_BLACKLIST_WORD = "blacklist_word";
    public static final String COLUMN_BLACKLIST_WORD_COUNTER = "blacklist_word_counter";

    public static final String CREATE_TABLE = "create table " + TABLE_NAME +
            "(" + COLUMN_WORD_ID + " integer primary key, "
            + COLUMN_BLACKLIST_WORD + " text not null, "
            + COLUMN_BLACKLIST_WORD_COUNTER + " integer " + ");";
}